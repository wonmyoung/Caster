...
public class FollowingListActivity extends CommonActivity implements ItemBindStrategy, IResponseListener {
    ...
    private void loadDummyItemList(ArrayList<ICommonItem> list)
    {
        for (int i = 0 ; i < 100 ; i ++)
        {
            ...
            followingVector.setItemType(ItemConstant.FOLLOWING_INFO_ITEM);
